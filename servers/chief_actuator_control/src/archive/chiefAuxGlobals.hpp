...
extern double GLOB_CA_TIPTILT_VOLTAGE_FACTOR;
extern double GLOB_CA_TIPTILT_PIXEL_CONVERSION;
extern double CURRENT_DEXTRA_X_VOLTAGE;
extern double CURRENT_DEXTRA_Y_VOLTAGE;
extern double CURRENT_SINISTRA_X_VOLTAGE;
extern double CURRENT_SINISTRA_Y_VOLTAGE;
