...
ny=1080
bytes_pix = 1
folder = '/Users/jhansen/Documents/GitRepos/tetra3/pyxis_tests/data/200627/'

file = folder + 'stars3.raw'
outname = folder + 'stars3.fits'
dfiles = glob.glob(folder + 'dark?.raw')

bytes_pix = 2
file = folder + 'stars16_2.raw'
outname = folder + 'stars16_2.fits'
dfiles = glob.glob(folder + 'dark16_?.raw')
