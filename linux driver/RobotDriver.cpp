...
void AccelerationTester::WriteToFile() {
	if(!file_open_flag_){
		...
		readme_file << "test_number: " << test_number_ << "\n"
					...
					<< "Acc1_x_ground_state: " << acc1_ground_state_.x << '\n'
					<< "Acc1_y_ground_state: " << acc1_ground_state_.y << '\n'
					<< "Acc1_z_ground_state: " << acc1_ground_state_.z << '\n'
					<< "Acc2_x_ground_state: " << acc2_ground_state_.x << '\n'
					<< "Acc2_y_ground_state: " << acc2_ground_state_.y << '\n'
					<< "Acc2_z_ground_state: " << acc2_ground_state_.z << '\n'
					<< "Acc3_x_ground_state: " << acc3_ground_state_.x << '\n'
